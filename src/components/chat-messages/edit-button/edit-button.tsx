...
export const EditButton: React.FC = () => {
    ...
    const items = [
        ...
        },
        {
            ...
            icon: <DeleteIcon className={classNames(classes['popup-item__icon'], classes['popup-item__icon-delete'])}/>,
        },
        {
    ...
    return (
        ...
        >
            <List items={items} className={classes['popup']}>
                {
                    ({ title, icon }) => (
                        <Grid key={title} alignItems='center' className={classes['popup-item']}>
                            {icon}
