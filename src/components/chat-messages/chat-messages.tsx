...
export const ChatMessages: React.FC<Props> = ({ className }: Props) => {
  const items: ItemType[] = [
    ...
    },
    {
      ...
      avatarURL: '/img/pexels-photo-2613260.jpeg',
      message:
        'Call park out she wife face mean. Invitation excellence imprudence understood it continuing to. Ye show done an into.  ',
      time: '10:10 PM',
    },
    {
      id: '3',
