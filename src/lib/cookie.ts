...
class Init {
    ...
    set(ctx: NextPageContext | null, key: string, value: string, attributes?: Attributes) {
    ...
    get(ctx: NextPageContext | null, key?: string) {
        ...
        const cookies = ctx ? ctx.req.headers['cookie'].split('; ') : document.cookie.split('; ');
        const jar = {};
    ...
    withAttributes(attributes: Attributes) {
        return new Init(this.converter, assign({}, this.defaultAttributes, attributes));
    }
    
    withConverter(converter) {
        return new Init(assign({}, this.converter, converter), this.defaultAttributes);
    }
}
